...
public class GestionFormationApplication 
{
    ...
    public static void main(String[] args) throws ParseException
    {
         ...
         */
         ...
         List<Document> doc1_all = documentRepository.findAll();
         System.out.println("all : "+doc1_all);
         ...
         //System.out.println("formation1 fetch : "+formation_fetchAll);
         ...
         ResponsableFormation responsableFormation1 = new ResponsableFormation(formation_fetchAll, "ayoub", "ayoub",  df.parse("2000-12-21"));
         
         //responsableFormationRepository.save(responsableFormation1);
         
         List<ResponsableFormation> responsableFormation1_fetchAll = responsableFormationRepository.findByName("ayoub");
         ...
         //formation_fetchAll.get(0).set(responsableFormation1_fetchAll.get(0));
         ...
         System.out.println("sessions : "+sessionFormationRepository.findAll().get(0).getDateSession());
