angular.module('GestionFormation')
    ...
    {
        function getData(url,header,method,data,response)
    {
        ...
        var url = properties.urlServer+""+url;
        ...
        switch(method){
            ...
            case HTTP_METHOD.post:
                promise =  $http.post(url, data, {timeout: properties.timeout});
                 break;
            ...
            case HTTP_METHOD.put:
                promise = $http.put(url, data, {timeout: properties.timeout});
                  break;
